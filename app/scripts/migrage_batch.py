...
def import_batch_data():
    ...
    if not os.path.exists(post_path):
        ...
        return
    social_path = os.path.join(os.getcwd(), "data_scripts", "toktak.social_posts.json")
    ...
    for social in social_data:
        ...
        if batch_id:
            ...
            for social_post in social_posts:
                ...
                post_id = post_id.get("$oid") if isinstance(post_id, dict) else post_id
            ...
            for item in data:
                ...
                for post in posts:
                    ...
                    new_post = Post(
                        ...
                        social_sns_description=post.get("social_sns_description", ""),
