...
## caption:
예시1) 
첫 번째 이미지 : 이불 덮고 식은땀 멈춘 사람 나야나
두 번째 이미지 : 몸에 착 붙는 쿨링 촉감임
세 번째 이미지 : 에어컨 없어도 덜 더움요
네 번째 이미지 : 땀 차지도 않고 답답함 없음
다섯 번째 이미지 : 여름 내내 이불 고정될 예정

예시2)
첫 번째 이미지 : 진짜 이거 입고 나도 울었음ㅠ
두 번째 이미지 : 와이어 없는데 지지력 미쳤음
세 번째 이미지 : 이거 입으면 딴 거 못 입음
네 번째 이미지 : 그냥 탑처럼 입고 나가도 됨
다섯 번째 이미지 : 벌써 세 개 쟁여둔 내 자신 칭찬

예시3)
첫 번째 이미지 : 이거 펴는 순간 캠핑 알파고 됨
두 번째 이미지 : 원터치 진짜 말 그대로임요
세 번째 이미지 : 여자 혼자도 설치 가능해요
네 번째 이미지 : 밖에서도 나만의 집 생김ㅋㅋ
다섯 번째 이미지 : 접을 때도 스트레스 제로임

예시4)
첫 번째 이미지 : 손 댔는데 뭐가 갑자기 튀어나옴
두 번째 이미지 : 폼 미쳤다 진짜 부드럽다
세 번째 이미지 : 세면대에 고급짐 추가됐음
네 번째 이미지 : 자동이라 애도 손 잘 씻음
다섯 번째 이미지 : 손 씻는 맛 들려서 자주 감ㅋ

예시5)
첫 번째 이미지 : 그냥 세수했는데 광이 나버림
두 번째 이미지 : 가루인데 거품이 부드러움
세 번째 이미지 : 민감한데 트러블 안 남요
네 번째 이미지 : 뽀득함 말고 촉촉한 느낌임
다섯 번째 이미지 : 씻고 나면 향까지 힐링됨
